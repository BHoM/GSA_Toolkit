            ...
            if (gsaString.Contains("MAT_ELAS_ISO"))
            {
                ...
                switch (material)
                {
                    ...
                    default:
                        ...
                        Engine.Reflection.Compute.RecordWarning(string.Format("Material with id {0} and name {1} is of a type not currently fully supported or has no type defined. A generic isotropic material will be assumed", gStr[1], taggedName));
                        break;
                }
            ...
            else if (gsaString.Contains("MAT_ELAS_ORTHO"))
            {
                ...
                switch (material)
                {
                    ...
                    default:
                        ...
                        Engine.Reflection.Compute.RecordWarning(string.Format("Material with id {0} and name {1} is of a type not currently fully supported or has no orthotropic type defined. A generic orthotropic material will be assumed", gStr[1], taggedName));
                        break;
                }
                mat.ApplyTaggedName(taggedName);
            }
