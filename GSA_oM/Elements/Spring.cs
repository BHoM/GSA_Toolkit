...
{
    [Description("Models a spring.")]
    public class Spring : BHoMObject, ILink<Node>
    {
        /***************************************************/
        /**** Properties                                ****/
        /***************************************************/
        ...
        [Description("Spring property of the spring, defining the stiffness.")]
        public virtual LinearSpringProperty SpringProperty { get; set; } = null;

        [Angle]
        [Description("Controls the local axis orientation of the Spring \n" +
                     ...
                     "A Spring is vertical if its projected length to the horizontal plane is less than 0.0001, i.e. a tolerance of 0.1mm on verticality. \n" +
